...
const Card = (props)=>{
    ...
    return (
        <div className="relative group overflow-hidden flex flex-col w-70  rounded-md shadow-xl items-center pb-4 gap-1  transition-transform duration-300 ease-in-out hover:scale-105  px-5">
